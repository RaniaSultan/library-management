        ...
        <form action="{{ route('books.store') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="description" class="mt-1 block w-full border border-gray-300 rounded-md p-2">{{ old('description') }}</textarea>
                </div>
                <div>
                    <label class="block text-sm font-medium text-gray-700">Author *</label>
                    <select name="author_id" required class="mt-1 block w-full border border-gray-300 rounded-md p-2">
